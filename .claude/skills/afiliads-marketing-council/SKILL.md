...
4. **Brand level** — if the ask is a first-party product: is this the e-book (impulse,
   R$ 29–67) or the platform / affiliate program? Seat Schwartz + Hormozi
   for product; Dunford + Godin for platform. Do not let the council sell
   both on one page.
4. **Brand level** — if the ask is a first-party product: is this the e-book (impulse,
   R$ 29–67) or the platform / affiliate program? Seat Schwartz + Hormozi
   for product; Dunford + Godin for platform. Do not let the council sell
...
- **If a video-analysis skill is installed** (e.g., `afiliads-watch-video`): pull takes from specific talks/interviews the research surfaces.
