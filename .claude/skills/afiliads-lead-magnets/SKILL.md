---
name: afiliads-lead-magnets
description: When the user wants to create, plan, or optimize a lead magnet for email capture or lead generation. Also use when the user mentions "lead magnet," "gated content," "content upgrade," "downloadable," "ebook," "cheat sheet," "checklist," "template download," "opt-in," "freebie," "PDF download," "resource library," "content offer," "email capture content," "Notion template," "spreadsheet template," or "what should I give away for emails." Use this for planning what to create and how to distribute it. For writing the actual content, see afiliads-copywriting.
metadata:
  version: 2.0.0
---
...
- On a low-ticket e-book landing (R$ 29–67), the freebie must not outshine
  the paid file on the same URL. Give the magnet its own page. The paid
  CTA stays "Quero o e-book"; the magnet CTA is capture, not a second sale.
- On a low-ticket e-book landing (R$ 29–67), the freebie must not outshine
  the paid file on the same URL. Give the magnet its own page. The paid
  CTA stays "Quero o e-book"; the magnet CTA is capture, not a second sale.
...
As referências abaixo são extensões opcionais, não pré-requisitos. Verifique
se cada skill existe no runtime antes de delegar; quando ausente, registre
`DEPENDENCIA_OPCIONAL_AUSENTE` e preserve o escopo local sem simular o handoff.
