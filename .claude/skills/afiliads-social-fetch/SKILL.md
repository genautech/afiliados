...
| `youtube.com/watch?v=<id>` or `youtu.be/<id>` | → defer to `afiliads-watch-video` |
...
- `afiliads-watch-video` — for YouTube URLs (or any video — Loom, Vimeo, Riverside, MP4), route there instead.
