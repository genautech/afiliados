...
**Preflight de superfície de marca:** quando o pedido for marca, site,
onboarding ou portal da marca, leia `brandkit/brand-visual.md`
antes dos exemplos genéricos desta skill. Nesse nível, os tokens do Brand Kit,
fotografia P&B, zero verde, zero gradiente no símbolo, zero sombra de logo e
zero raio vencem qualquer sugestão de teal, gradiente ou sombra abaixo. Para
produto, use apenas o preset aprovado do produto.
